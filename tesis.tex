...
\examiner{Prof.}{Bruno}{Bazzano}{MSc. Ing.}
\examiner{Prof.}{Marcelo}{Forets}{PhD.}
%%
...
%
\foreignkeyword{Corrotational formulation}
\foreignkeyword{Finite element method}
\foreignkeyword{Structural dyinamics}
\foreignkeyword{Over head transmission lines}
