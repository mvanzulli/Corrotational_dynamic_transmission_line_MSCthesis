...
\escritura{Maestría en Ingeniería Estrucutral} % Se indica que el programa de Posgrado sea "en" o "de" tal área.
%%
\director{Prof.}{Jorge}{Pérez Zerpa}{Dr.}
\directoracademico{Prof.}{Gabriel}{Usera}{D.Sc.}
%%
\examiner{Prof.}{Gonzalo}{Cetrángolo}{D.Sc.}
\examiner{Prof.}{Bruno}{Bazzano}{M.Sc.}
\examiner{Prof.}{Marcelo}{Forets}{D.Sc.}
%%
\graduatename{Ingeniería Estructural}
\institute{Instituto de Estructuras y Transporte}{Facultad de Ingeniaría de la Universidad de la Repíblica del Uruguay}  % La primer institución es la principal.
