...
\begin{frame}{Problema:}{}
	\begin{figure}[htbp]
		...
		\subfigure[Colapso de torre en Chubut-Argentina, 2020 \href{https://www.clarin.com/sociedad/fenomeno-galloping-cayeron-torres-alta-tension-patagonia_0_fc3FYz1O-.html}{\structure{Noticia Clarín}}]{\includegraphics[width=0.45\textwidth]{./imagenes/Introduccion/TorreColapsada.jpg}}
	\end{figure}
\end{frame}
...
\begin{figure}[htbp]
	\centering
	\subfigure[Desplazamiento vertical de A según $y$]{\includegraphics[width=0.48\textwidth]{./imagenes/ResultadosNumericos/RightAngeCantilever/RA_Dispy_NodeA.png}}
	\subfigure[Desplazamiento vertical de A según $y$ por {\color{blue}(Le,2014)} ] {\includegraphics[width=0.37\textwidth]{./imagenes/ResultadosNumericos/RightAngeCantilever/BattiniDispA.png}}
...
\begin{frame}{Validación del nodo B:}
	...
	\begin{figure}[htbp]
		\centering
		\subfigure[Desplazamiento vertical de B según $z$ ]{\includegraphics[width=0.48\textwidth]{./imagenes/ResultadosNumericos/RightAngeCantilever/RA_Dispz_NodeB.png}}
		\subfigure[Desplazamiento transversal según $z$ por {\color{blue}(Le,2014)} ] {\includegraphics[width=0.37\textwidth]{./imagenes/ResultadosNumericos/RightAngeCantilever/BattiniDispB.png}}
...
\begin{frame}{Acción del viento:}
	\begin{figure}[htbp]
		\centering
		\subfigure[Perfil de velocidad en $z$]{\includegraphics[width=0.42\textwidth]{./imagenes/ResultadosNumericos/SimpleCable/PerfilVm_TL_Foti.png}}
		\subfigure[Perfil de fuerza en $z$] {\includegraphics[width=0.42\textwidth]{./imagenes/ResultadosNumericos/SimpleCable/FuerzaNodalZ_TLFoti.png}}		
...
\begin{frame}{Ángulo de balanceo:}
	\begin{figure}[htbp]
		...
		\subfigure[Ángulo de balanceo $\Phi$ en función de la velocidad media $W(t)$.] {\includegraphics[width=0.42\textwidth]{./imagenes/ResultadosNumericos/SimpleCable/Angulo_Foti.png}}
	\end{figure}
\end{frame}
...
\begin{frame}{Acción del viento:}
	\begin{figure}[htbp]
		\centering
		\subfigure[Perfil de vlocidad de viento en $z$ ] {\includegraphics[width=0.42\textwidth]{./imagenes/ResultadosNumericos/TransmissionTormenta/VelocidadNodalX_TS.png}}
		\subfigure[Carga aplicada sobre los nodos]{\includegraphics[width=0.42\textwidth]{./imagenes/ResultadosNumericos/TransmissionTormenta/FuerzaNodalX_TS.png}}
...
\begin{frame}{Resultados ángulo de balanceo:}
	\begin{figure}[htbp]
		...
		\subfigure[Perfil de velocidades en $z$ según \color{blue}(Stengel,2017)] {\includegraphics[width=0.42\textwidth]{./imagenes/ResultadosNumericos/TransmissionTormenta/Angulo_TS_NodeAD.png}}
...
%			\begin{itemize}
%				\item Incondicionalmente estable.
...
%			\begin{split}
%				\bf{K}_{tot}= (1+\alpha_{HHT})&\bf{K}_g+\text{$\left( \frac{4}{(1-\alpha_{HHT}^2)\\delta_t^2} \right)$} \bf{M}\bf{B}_t...\\ &...\left(\text{$\frac{1^2+\alpha^2_{HHT}}{2\delta_t}$}\right) (\bf{C}_k+\bf{C}_{vis}) \bf{B}_t 
%				\end{split}
%			\end{equation}
%		\end{block}
%	\end{minipage}
...
\begin{frame}{Resultados TS desplazamientos:}
\begin{figure}[htbp]
	\centering
