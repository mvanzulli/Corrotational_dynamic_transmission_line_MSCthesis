...
\begin{figure}[htbp]
	\centering
	\subfigure[Esquema de desplazamientos locales ]{	\def\svgwidth{80mm}
		\input{./imagenes/Preliminares/Corrotacional/IlusLocalDisp.pdf_tex}}\label{fig:PRE:IlusLocalDisp}
	\subfigure[Esquema de angulos locales ]{	\def\svgwidth{90mm}
...
Se destaca que la matriz tangente de la Ecuación  \eqref{Eqn:PRE:MatrizKest2} es asimétrica, sin embargo según \cite{Rankin1986} esta puede ser simetrizada sin perder la convergencia cuadrática 
